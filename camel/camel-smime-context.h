...
void camel_smime_context_set_sign_mode (CamelSMIMEContext *context, CamelSMIMESignMode mode);

CamelSMIMEDescribeFlags camel_smime_context_describe_part (CamelSMIMEContext *context, CamelMimePart *part);
