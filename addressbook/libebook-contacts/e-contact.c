 ...
 *
 * Returns: (transfer full) (nullable) (optional): Depends on the field's type, owned by the caller. This may be %NULL if the field isn't set.
 **/
gpointer
 ...
 *
 * Returns: (transfer none) (array length=len) (nullable) (optional): the inlined image in the
 ...
 *
 * Returns: (transfer none) (nullable) (optional): the MIME type of the image, or %NULL if it has not been set.
 *
 * Since: 3.2
 **/
const gchar *
 ...
 *
 * Returns: (transfer none) (nullable) (optional): the URI of the image, or %NULL if it has not been set
 *
 * Since: 3.2
 **/
const gchar *
