 ...
 * @sexp: (nullable) (optional): the search expression to set, or %NULL for unfiltered results
 ...
 * @cursor: an #EDataBookCursor
 * @revision_guard: (nullable) (optional): The expected current addressbook revision, or %NULL
 ...
 * @matches_sexp: (out) (nullable) (optional): return location to set whether @contact matched @cursor's search expression
 *
