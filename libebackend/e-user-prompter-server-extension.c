 ...
 * @parameters: (nullable) (optional): Optional extension parameters for the dialog, as passed by a caller
 *
 ...
 * @values: (nullable) (optional): Additional response values, if extension defines any
 *
